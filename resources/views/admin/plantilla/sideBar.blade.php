                ...
                @foreach (Auth::user()->rol->menu() as $pantalla_menu) 
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"  >
                            <i class="{{$pantalla_menu->icono}}"></i>
                            <span class="hide-menu">{{$pantalla_menu->nombre}}</span>
                        </a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            @foreach($pantalla_menu->sub_menu() as $sub_menu)
                                <li class="sidebar-item">
                                    ...
                                    <a href="{{$sub_menu->url}}" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu">{{$sub_menu->nombre}}</span>
                                    </a>
                                </li>   
                            @endforeach                         
